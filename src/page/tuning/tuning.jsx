...
import GridMenuComponent, { GridMenuTuningComponent } from "../../useState/gridMenu";
import VerticalMenuComponent, { VerticalMenuTuningComponent } from "../../useState/verticalMenu";
...
const MotorComponent = () => {
  ...
  const getUniqueValues = (data, key) => {
    return Array.from(
      new Set(data.map((item) => item[key]?.toString().toLowerCase()))
    ).map(
      (value) =>
          ...
          <MotorBodyContainer>
            ...
            <MainBodyDiv>
              ...
              <div>
                ...
                {active ? (
                  <GridMenuTuningComponent filter={filteredData} />
                ) : (
                  <VerticalMenuTuningComponent filter={filteredData} />
                )}
              </div>
            </MainBodyDiv>
          </MotorBodyContainer>
