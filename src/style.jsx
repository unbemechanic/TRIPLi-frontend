...
export const SocialIcon = styled.div`
  /* background-color: ${(props) =>
    props.$n ? "#039600" : (props) => (props.$g ? "#BC0000" : "#FFC700")}; */
  border-radius: 50%;
  font-size: 25px;
  font-weight: 900;
  color: white;
...
export const MotorH = styled.div`
  ...
  font-family: Montserrat;
  font-size: ${(props) =>
    props.$motor ? "80px" : (props) => (props.$ranges ? "27px" : "16px")};
  font-style: normal;
  ...
  background: ${(props) =>
    props.$first
      ...
      : (props) =>
          props.$second
            ? `url(${Compare2})`
            : (props) => (props.$third ? `url(${Compare3})` : "")};
  background-repeat: no-repeat;
...
export const Heading = styled.div`
  ...
  font-size: ${(props) =>
    props.$name
      ? "16px"
      : (props) =>
          props.$brand ? "12px" : (props) => (props.$price ? "22px" : "")};
  font-style: normal;
  font-weight: ${(props) =>
    props.$name
      ? "600"
      : (props) =>
          props.$brand ? "400" : (props) => (props.$price ? "700" : "")};
