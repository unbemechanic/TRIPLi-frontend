...
import SignComponent from "../page/register";
import { Backdrop, colors, TextField } from "@mui/material";
import {
  LogInForm,
  LogInInputs,
  LongDash,
...
export default function BasicModal() {
  ...
  return (
    <div>
      <Button sx={{ marginLeft: "-40px" }} onClick={handleOpen}>
        <svg
        ...
        >
          <path
            d="M9.2041 7.3125C9.2041 10.1036 11.4755 12.375 14.2666 12.375C17.0577 12.375 19.3291 10.1036 19.3291 7.3125C19.3291 4.52137 17.0577 2.25 14.2666 2.25C11.4755 2.25 9.2041 4.52137 9.2041 7.3125ZM23.2666 23.625H24.3916V22.5C24.3916 18.1586 20.858 14.625 16.5166 14.625H12.0166C7.6741 14.625 4.1416 18.1586 4.1416 22.5V23.625H23.2666Z"
            fill="#006DAB"
          />
        </svg>
      </Button>
      <Modal
        style={{ backdropFilter: "blur(8px)", zIndex: "99999" }}
        open={open}
        onClose={handleClose}
