...
export default function BasicModalSide() {
      ...
      >
        ...
        <SignBackground>
                    <SignContainer>
                        ...
                        <div>
                            <div>Password</div>
                            <TextField type='password' sx={{width:'100%'}} id="outlined-basic" label="Password" variant="outlined" />
                        </div>
                        ...
                        <Button sx={{width:'100%', height:'50px'}} variant="contained">SIGN IN</Button>
                        ...
                        <SLink to="/register"><Button  onClick={handleClose} sx={{width:'100%', height:'50px'}} variant="outlined">CREATE ACCOUNT</Button></SLink>
                    </SignContainer>
                </SignBackground>
        </Box>
      </Modal>
